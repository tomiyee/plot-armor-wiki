...
/**
 * DialogBody is the scrollable content area of the dialog, matching the
 * Blueprint.js DialogBody pattern. It grows to fill available space and
 * provides overflow scrolling when content exceeds the dialog's max height.
 */
